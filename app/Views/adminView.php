            ...
            <table>
                ...
                <?php foreach($utilisateurs as $utilisateur) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= ($utilisateur->est_admin) ? url_to(getRoute("enleverAdmin"), $utilisateur->id_client) : url_to(getRoute("mettreAdmin"), $utilisateur->id_client) ?>">
                                <div class="button"><?= ($utilisateur->est_admin) ? "Enlever admin" : "Mettre admin" ?></div>
                            </a>
                        </td>

                        <td>
                            <a href="<?= url_to(getRoute("supprimerUtilisateur"), $utilisateur->id_client) ?>">
            ...
            <table>
                ...
                <?php foreach($produits as $produit) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url_to(getRoute("modifierProduitVue"), $produit->id_produit) ?>">
                                <div class="button">Modifier produit</div>
                            </a>
                        </td>

                        <td>
                            <a href="<?= url_to(getRoute("supprimerProduit"), $produit->id_produit) ?>">
            ...
            <div class="exemplaires_produits_container">
                ...
                <?php foreach($exemplairesParCouleurTailleProduits as $idProduit => $exemplaireTailles) : ?>
                    ...
                    <div class="produit_exemplaire">
                        ...
                        <a href="<?= url_to(getRoute("modifierExemplaireImagesVue"), $idProduit) ?>">
                    ...
                    <div class="exemplaires_tailles_container">
                        ...
                        <?php foreach($exemplaireTailles as $taille => $exemplaireCouleurs) : ?>
                            ...
                            <h3><?= ($taille != NULL) ? $taille : "Standard" ?> : <span class="green"><?= $quantiteTotal ?> disponibles</span></h3>
                            ...
                            <div class="exemplaires_couleurs_container">
                                ...
                                <?php foreach($exemplaireCouleurs as $couleur => $quantite) : ?>
                                    <div class="exemplaire_couleurs">
                                        ...
                                        <a href="<?= url_to(getRoute("supprimer1Exemplaire"), $idProduit, $taille, $couleur) ?>">
                                            <div class="button small">Supprimer 1</div>
                                        </a>

                                        <a href="<?= url_to(getRoute("supprimerTousLesExemplaires"), $idProduit, $taille, $couleur) ?>">
            ...
            <form id="creer_exemplaire" class="creer_exemplaire_form" action=<?= url_to(getRoute("creerExemplaire")) ?> method="post" enctype='multipart/form-data'>
                ...
                <div>
                    ...
                    <select id="taille" name="taille">
                        ...
                        <optgroup label="Tailles accessoires">
            ...
            <table>
                ...
                <?php foreach($collections as $collection) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url_to(getRoute("modifierCollection"), $collection->id_collection) ?>">
                                <div class="button">Modifier collection</div>
                            </a>
                        </td>

                        <td>
                            <a href="<?= url_to(getRoute("supprimerCollection"), $collection->id_collection) ?>">
            ...
            <table>
                ...
                <?php foreach($coupons as $coupon) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url_to(getRoute("modifierCouponVue"), $coupon->id_coupon) ?>">
                                <div class="button">Modifier coupon</div>
                            </a>
                        </td>

                        <td>
                            <a href="<?= url_to(getRoute("supprimerCoupon"), $coupon->id_coupon) ?>">
