...
<head>
    ...
    <link rel="stylesheet" href=<?= site_url() . "css/cgu.css"?>>
...
<body>
    ...
    <div class="cgu_container">
        <h1>Conditions générales d'utilisation du site Hot genre</h1>

        <h2>Article 1 : Objet</h2>
        <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site Hot genre et leur utilisation par « l'Utilisateur ».</p>
        ...
        <p>Hot genre se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>
        ...
        <p>Le site permet à l'Utilisateur un accès gratuit aux services.</p>
        ...
        <p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de Hot genre.</p>
        ...
        <p>L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l'adresse hotgenre@gmail.com.</p>
        ...
        <p>En vertu des articles 48 et suivants de la loi n° 78-17 relative à l'informatique, aux fichiers et aux libertés en date du 6 janvier 1978, réécrite par l'ordonnance n° 2018-1125 du 12 décembre 2018 applicable au 1er juin 2019, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via son espace personnel, un formulaire de contact ou par mail à hotgenre@gmail.com</p>
